                                ...
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        <?php
                                                        ...
                                                        $query = "SELECT id FROM register where usertype=1 ORDER BY id ";  
                                ...
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        <?php
                                                        ...
                                                        $query = "SELECT id FROM register where usertype=2 ORDER BY id ";  
                                                        $query_run = mysqli_query($connection, $query);
                                                        $row = mysqli_num_rows($query_run);
                                ...
                                <div class="col mr-2">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-auto">
                                            ...
                                            $queryy = "SELECT id FROM todo ORDER BY id";  
                                            $query_runn = mysqli_query($connection, $queryy);
                                            $roww = mysqli_num_rows($query_runn);
                                            echo '<h4>  Project:-'.$roww.'</h4>';
                                        ?>
